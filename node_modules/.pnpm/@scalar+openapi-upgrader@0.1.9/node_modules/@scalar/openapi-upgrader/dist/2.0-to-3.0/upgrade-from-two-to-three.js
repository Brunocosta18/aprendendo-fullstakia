    ...
    for (const [name, response] of Object.entries(responses)) {
      if (response && typeof response === "object") {
        if ("$ref" in response) {
          ...
          const produces = document.produces ?? ["application/json"];
          ...
          if (responseObj.examples && typeof responseObj.examples === "object") {
            ...
            for (const [mediaType, exampleValue] of Object.entries(responseObj.examples)) {
              if (typeof responseObj.content[mediaType] !== "object") {
                ;
                responseObj.content[mediaType] = {};
              }
              ;
              responseObj.content[mediaType].example = exampleValue;
            }
